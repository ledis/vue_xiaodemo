...
<style scoped> 
.content .fhbtn{ width:6.4rem;height:0.6rem;}
.content .fhbtn a{ display:block;width:0.6rem;height:0.6rem; background:url(../../assets/img/history1.png) no-repeat center center; background-size:0.23rem 0.25rem; }
.content h1{width:1.80rem;height:1rem; background:url(../../assets/img/Logo.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
